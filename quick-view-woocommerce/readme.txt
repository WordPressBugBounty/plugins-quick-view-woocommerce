...
== Description ==
 [Live Demo](http://demo.xootix.com/quick-view-for-woocommerce/)
...
4. The quick view admin settings page.

== Changelog ==
= 1.7 =
* Fixed lightbox issue for woocommerce 3.0.

= 1.6 =
* Fixed navigation icon disappearing.
* New premium features.

= 1.5 =
* New - Quick View button on image hover.
* Fixed Bugs.

= 1.4 =
* New - Select animation for quick view modal/box.
* New - Exit quick view using ESC key.
* New - Enable/Disable quick view icon.
* New - Set your own font size.

= 1.3 =
* Fix - Fully Responsive now.
* Added image width option
